...
void createObject3(Object *inputObjectAddress,MKBitmap *inputBitmaps,MKSample *inputSamples){
    ...
    inputObjectAddress[1] = create_object(1110, 500, 35, 35, inputBitmaps->reward_image, 3, false, true, true, NULL,inputSamples->check);
    inputObjectAddress[2] = create_object(955, 300, 35, 35, inputBitmaps->reward_image, 3, false, true, true, NULL,inputSamples->check);
    inputObjectAddress[3] = create_object(2100, 380, 35, 35, inputBitmaps->reward_image, 3, false, true, true, NULL,inputSamples->check);
    inputObjectAddress[4] = create_object(2300, 480, 35, 35, inputBitmaps->reward_image, 3, false, true, true, NULL,inputSamples->check);
    inputObjectAddress[5] = create_object(2500, 580, 35, 35, inputBitmaps->reward_image, 3, false, true, true, NULL,inputSamples->check);
    inputObjectAddress[6] = create_object(2700, 680, 35, 35, inputBitmaps->reward_image, 3, false, true, true, NULL,inputSamples->check);

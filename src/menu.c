...
int openMenu(Player *playerInput,Camera* cameraInput,bool* menu_active,ALLEGRO_MOUSE_STATE* mouseState,ALLEGRO_FONT *font_48,int *score){
    ...
    al_draw_text(font_48, al_map_rgb(190, 0, 190),cameraInput->x+cameraInput->cameraWidth*4/8-105,cameraInput->y+cameraInput->cameraHeight*4/8+3*button_height/2, ALLEGRO_ALIGN_LEFT,"Read file");
    al_draw_text(font_48, al_map_rgb(190, 190, 190),cameraInput->x+cameraInput->cameraWidth*4/8-125,cameraInput->y+cameraInput->cameraHeight*4/8+7*button_height/2, ALLEGRO_ALIGN_LEFT,"Player rank");
